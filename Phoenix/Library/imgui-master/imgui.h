...
namespace ImGui
{
    ...
    IMGUI_API bool          DragFloat3(const char* label, ImGuiID id[3], float v[3], float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* format = "%.3f", float power = 1.0f); // Phoenix Original
    ...
    IMGUI_API bool          DragScalarN(const char* label, ImGuiID* id, ImGuiDataType data_type, void* p_data, int components, float v_speed, const void* p_min = NULL, const void* p_max = NULL, const char* format = NULL, float power = 1.0f); // Phoenix Original
