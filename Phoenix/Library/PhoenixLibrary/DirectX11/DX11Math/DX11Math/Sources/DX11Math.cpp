...
#pragma region Functions for Vector4x4
		DirectX::XMFLOAT4X4 ConvertToFloat4x4FromVector4x4(const Vector4x4 m)
		{
		...
		DirectX::XMMATRIX ConvertToMatrixFromVector4x4(const Vector4x4 m)
		{
			DirectX::XMFLOAT4X4 mT;
			DirectX::XMMATRIX rM;
		...
		Vector4x4 ConvertToVector4x4FromFloat4x4(const DirectX::XMFLOAT4X4& m)
		{
			Vector4x4 mT;
		...
		Vector4x4 ConvertToVector4x4FromMatrix(const DirectX::XMMATRIX& m)
		{
			Vector4x4 rM;
			DirectX::XMFLOAT4X4 mT;
		...
		Vector4x4 MatrixMultiply(const Vector4x4 m1, const Vector4x4 m2)
		{
...
#pragma region Functions for Quaternion
		...
		Quaternion ConvertToQuaternionFromRotationMatrix(const Vector4x4 m)
		{
			DirectX::XMVECTOR v;
		...
		Vector4x4 ConvertToRotationMatrixFromQuaternion(const Quaternion q)
		{
