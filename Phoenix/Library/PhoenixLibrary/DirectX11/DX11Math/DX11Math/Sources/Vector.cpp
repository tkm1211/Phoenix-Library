...
#pragma region Vector4x4
		float& Vector4x4::operator () (unsigned int row, unsigned int col)
		{
			return m[row][col];
		}

		float  Vector4x4::operator () (unsigned int row, unsigned int col) const
		{
			return m[row][col];
		}
		...
		Vector4x4 Vector4x4::operator + (const Vector4x4& mat) const
		{
			return Vector4x4
			(
				_11 + mat._11, _12 + mat._12, _13 + mat._13, _14 + mat._14,
		...
		Vector4x4 Vector4x4::operator * (float f) const
		{
			return Vector4x4
			(
				_11 * f, _12 * f, _13 * f, _14 * f,
		...
		Vector4x4 operator * (float f, const Vector4x4& mat)
		{
			return Vector4x4
			(
