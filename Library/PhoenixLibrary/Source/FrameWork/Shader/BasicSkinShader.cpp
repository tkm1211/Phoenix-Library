	...
	namespace FrameWork
	{
		...
		bool BasicSkinShader::Initialize(Graphics::IGraphicsDevice* graphicsDevice)
		{
			...
			(
				...
				"C:\\Users\\2180082.MAETEL\\Desktop\\Phoenix\\Library\\PhoenixLibrary\\Build\\vs2019\\obj\\PhoenixLib_HLSL\\x86\\Debug\\BasicVSSkin.cso",
				inputElementDesc,
		...
		// シェーダー開始
		void BasicSkinShader::Begin(Graphics::IGraphicsDevice* graphicsDevice)
		{
