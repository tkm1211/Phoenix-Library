...
#define PHOENIX_LOG_TYPE_FWK	(1 << 8)
...
#define	PHOENIX_LOG_FWK_VERVOSE(...)	PHOENIX_LOG_IMPLE(PHOENIX_LOG_TYPE_FWK, Phoenix::FND::LogLevel::Vervose, __VA_ARGS__)
#define	PHOENIX_LOG_FWK(...)			PHOENIX_LOG_IMPLE(PHOENIX_LOG_TYPE_FWK, Phoenix::FND::LogLevel::Info, __VA_ARGS__)
#define	PHOENIX_LOG_FWK_WARNING(...)	PHOENIX_LOG_IMPLE(PHOENIX_LOG_TYPE_FWK, Phoenix::FND::LogLevel::Warning, __VA_ARGS__)
#define	PHOENIX_LOG_FWK_ERROR(...)		PHOENIX_LOG_IMPLE(PHOENIX_LOG_TYPE_FWK, Phoenix::FND::LogLevel::Error, __VA_ARGS__)