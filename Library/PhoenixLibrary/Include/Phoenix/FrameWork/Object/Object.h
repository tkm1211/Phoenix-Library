...
namespace Phoenix
{
	namespace FrameWork
	{
		...
		public:
			...
			void AddAnimationLayer(s32 setBaseAnimationIndex, s32 beginNodeIndex = -1, s32 endNodeIndex = -1);
			...
			// アニメーションの再生
			void PlayAnimation(u32 layerIndex, u32 clip, f32 fadeTime = 0.0f);

			// アニメーションの同時再生
			void PlayBlendAnimation(u32 layerIndex, u32 clip, f32 fadeTime = 0.0f);
